...
function GithubAuth() {
    ...
    return (
        <>
            <button onClick={() => window.location.href = `${import.meta.env.VITE_BACKEND_BASE_URL}/auth/github`} className='flex py-2 items-center gap-x-3 justify-center group border-2 border-gray-100 rounded-md  cursor-pointer  hover:bg-[#155DFC] hover:text-white duration-200 '>
